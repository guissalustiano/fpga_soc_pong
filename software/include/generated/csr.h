...
/* contador */
#define CSR_CONTADOR_BASE (CSR_BASE + 0x0L)
#define CSR_CONTADOR_CONTA_ADDR (CSR_BASE + 0x0L)
#define CSR_CONTADOR_CONTA_SIZE 1
static inline uint32_t contador_conta_read(void) {
	return csr_read_simple((CSR_BASE + 0x0L));
}
static inline void contador_conta_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x0L));
}
#define CSR_CONTADOR_CONTAGEM_ADDR (CSR_BASE + 0x4L)
#define CSR_CONTADOR_CONTAGEM_SIZE 2
static inline uint64_t contador_contagem_read(void) {
	uint64_t r = csr_read_simple((CSR_BASE + 0x4L));
	r <<= 32;
	r |= csr_read_simple((CSR_BASE + 0x8L));
	return r;
}
#define CSR_CONTADOR_FIM_ADDR (CSR_BASE + 0xcL)
#define CSR_CONTADOR_FIM_SIZE 1
static inline uint32_t contador_fim_read(void) {
